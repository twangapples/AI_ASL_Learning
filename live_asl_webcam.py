...
MODEL_PATH = _REPO_ROOT / "model" / "keypoint_classifier" / "keypoint_classifier.tflite"
LABEL_PATH = _REPO_ROOT / "model" / "keypoint_classifier" / "keypoint_classifier_label.csv"
